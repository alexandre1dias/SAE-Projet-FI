    ...
    def installation_dépendances(self):
        ...
        if os.path.exists(self.req_file):
            ...
            try:
                ...
                subprocess.check_call(
                    [self.python_venv, "-m", "pip", "install", "-r", self.req_file])
