...
ALTER TABLE ADMIN ADD FOREIGN KEY (idParamNotifAdmin) REFERENCES PARAMETRE_NOTIF_ADMIN(idParamNotifAdmin);

ALTER TABLE PARAMETRE_NOTIF_ADMIN ADD FOREIGN KEY (idAdmin) REFERENCES ADMIN(idAdmin);
...
ALTER TABLE NOTIFS ADD FOREIGN KEY (idAdmin) REFERENCES ADMIN(idAdmin);
...
ALTER TABLE RECEVOIRA ADD FOREIGN KEY (idAdmin) REFERENCES ADMIN(idAdmin);

ALTER TABLE FORMULAIRE_CONTACT ADD FOREIGN KEY (idMembre) REFERENCES MEMBRE(idMembre);
ALTER TABLE FORMULAIRE_CONTACT ADD FOREIGN KEY (idAdmin) REFERENCES ADMIN(idAdmin);

ALTER TABLE REPONDRE ADD FOREIGN KEY (idFormulaire) REFERENCES FORMULAIRE_CONTACT(idFormulaire);
ALTER TABLE REPONDRE ADD FOREIGN KEY (idAdmin) REFERENCES ADMIN(idAdmin);
...
ALTER TABLE IMAGERC ADD FOREIGN KEY (idImage) REFERENCES IMAGE(idImage);
ALTER TABLE IMAGERC ADD FOREIGN KEY (idCompetition) REFERENCES COMPETITION(idCompetition);

ALTER TABLE IMAGERE ADD FOREIGN KEY (idImage) REFERENCES IMAGE(idImage);
ALTER TABLE IMAGERE ADD FOREIGN KEY (idEventClub) REFERENCES EVENTCLUB(idEventClub);

ALTER TABLE IMAGERA ADD FOREIGN KEY (idImage) REFERENCES IMAGE(idImage);
