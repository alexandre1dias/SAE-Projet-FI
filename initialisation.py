...
class Initialisation():
    ...
    def main(self):
        ...
        if os.path.exists(self.app_script):
            ...
            try:
                subprocess.check_call([self.lancement_venv.get_python_venv(), "-m", "flask", "--app", self.app_script, "run"])
            except KeyboardInterrupt:
                print("\nArrêt de l'application.")
        else:
            print(f"Fichier '{self.app_script}' introuvable. Impossible de lancer Flask.")
