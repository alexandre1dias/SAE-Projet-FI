...
from monApp.forms import FiltreForm, InformationForm, PresseForm, ArticleForm
from monApp.models import InformationBD, PresseBD, ArticleBD, ImageArticleBD
...
def informations():
    ...
    return render_template("articles/informations.html",
